#*Ejercicio CONTROL_ACCESO:* Control de Acceso con Intentos (Bucle while y break)Escribe un programa que simule el acceso a una cuenta personal mediante una contraseña previamente definida (por ejemplo, "python123").
...
clave_correcta:str = "arm123"
intentos:int = 0

while intentos < 3:
    clave_usuario:str = input("Ingresa la contraseña: ")
    
    if clave_correcta == clave_usuario:
